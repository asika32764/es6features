...
- [map PLUS set PLUS weakmap PLUS weakset 資料結構](#map--set--weakmap--weakset-資料結構)
...
- [math PLUS number PLUS string PLUS object APIs](#math--number--string--object-apis-擴展)
